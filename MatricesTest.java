...
public class MatricesTest{
	...
	@Test
	public void determinant_for_1_cross_1_matrix(){
		Matrix matrix3 = new Matrix(1,1);
		matrix3.populateMatrix(1,1,3);
		int det = matrix3.getDeterminantOf();
		assertEquals(det,3);
	};

	@Test
	public void determinant_for_2_cross_2_matrix(){
	...
	@Test
	public void determinant_for_3_cross_3_matrix(){
		int[][] expectedMatrix = {};
		Matrix matrix3 = new Matrix(3,3);
		matrix3.populateMatrix(1,1,6);
		matrix3.populateMatrix(1,2,1);
		matrix3.populateMatrix(1,3,1);
		matrix3.populateMatrix(2,1,4);
		matrix3.populateMatrix(2,2,-2);
		matrix3.populateMatrix(2,3,5);
		matrix3.populateMatrix(3,1,2);
		matrix3.populateMatrix(3,2,8);
		matrix3.populateMatrix(3,3,7);
		int det = matrix3.getDeterminantOf();
		assertEquals(det, -306);
	};
}